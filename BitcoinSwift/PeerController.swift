...
public class PeerController {
  ...
  private var genesisBlockHash: SHA256Hash {
		...
		*/
		/*	Vertcoin
		let bytes: [UInt8] = [
				0x4D, 0x96, 0xA9, 0x15, 0xF4, 0x9D, 0x40, 0xB1,
				0xE5, 0xC2, 0x84, 0x4D, 0x1E, 0xE2, 0xDC, 0xCB,
				0x90, 0x01, 0x3A, 0x99, 0x0C, 0xCE, 0xA1, 0x2C,
				0x49, 0x2D, 0x22, 0x11, 0x04, 0x89, 0xF0, 0xC4]
		*/
		let bytes: [UInt8] = [
				0x4D, 0x96, 0xA9, 0x15, 0xF4, 0x9D, 0x40, 0xB1,
				0xE5, 0xC2, 0x84, 0x4D, 0x1E, 0xE2, 0xDC, 0xCB,
